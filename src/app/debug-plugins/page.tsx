...
export default function DebugPluginsPage() {
  ...
  const manualStorageTest = () => {
    ...
    try {
      ...
      addDebug(
        `✅ JSON storage test: stored ${JSON.stringify(testData)}, retrieved ${JSON.stringify(parsed)}`
      );
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-3">
          ...
          <button
            onClick={() => {
              checkStorage();
              if (pluginManager) loadPlugins(pluginManager);
            }}
        ...
        <div className="space-y-4">
          ...
          <div className="p-4 bg-blue-50 rounded-lg border">
            ...
            <p className="text-sm">
              Status:{' '}
              <span className={pluginManager ? 'text-green-600 font-medium' : 'text-red-600'}>
