          ...
          <div className="bg-gray-50 dark:bg-gray-700 rounded-lg p-3 lg:p-4 mb-4 lg:mb-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-2 lg:gap-4 text-xs lg:text-sm">
              <div>
                ...
                {settings.enableCollaboration ? 'Enabled' : 'Disabled'}
              </div>
              <div>
                <span className="font-medium">Auto-save interval:</span>{' '}
              ...
              <div>
                <span className="font-medium">Show cursors:</span>{' '}
                {settings.showOtherCursors ? 'Yes' : 'No'}
              </div>
              <div>
              ...
              <div>
                ...
                {settings.sessionTimeout / 60000}min
              </div>
            </div>
          </div>
        </div>
