...
// Icon imports
import { Search, Network, FileText, Hash, Folder, Plus, Edit3, Eye, GitBranch, BarChart3 } from 'lucide-react';
...
export default function Home() {
  ...
  const [markdown, setMarkdown] = useState('# Welcome to MarkItUp PKM\n\nStart writing your markdown here...\n\n## Features\n\n- **Wikilinks**: Create links with [[Note Name]]\n- **Tags**: Use #tag to organize\n- **Graph View**: Visualize connections\n- **Advanced Search**: Find anything quickly\n\nTry creating some notes with links and tags!');
  const [viewMode, setViewMode] = useState<'edit' | 'preview' | 'split' | 'graph'>('edit');
  ...
  const [graphStats, setGraphStats] = useState({ totalNotes: 0, totalLinks: 0, avgConnections: 0, maxConnections: 0, orphanCount: 0 });
