...
import { dataVisualizationPlugin, dashboardBuilderPlugin, reportGeneratorPlugin, dataImportPlugin, metricsTrackerPlugin } from './data-analytics-plugins';
import { webhookIntegrationPlugin, automationRulesPlugin, scheduleReminderPlugin, bulkOperationsPlugin, syncIntegrationPlugin } from './automation-integration-plugins';
import { versionHistoryPlugin, commentSystemPlugin, reviewWorkflowPlugin, conflictResolutionPlugin, teamDashboardPlugin } from './version-collaboration-plugins';

// Import Phase 2 expansion plugins
import { advancedMarkdownEditorPlugin, templateEnginePlugin, contentStructurePlugin, multiFormatExportPlugin, contentStatisticsPlugin } from './enhanced-content-plugins';
...
export const PLUGIN_CATEGORIES = {
  ...
  '📊 Data & Analytics': [dataVisualizationPlugin, dashboardBuilderPlugin, reportGeneratorPlugin, dataImportPlugin, metricsTrackerPlugin],
  '⚡ Automation & Integration': [webhookIntegrationPlugin, automationRulesPlugin, scheduleReminderPlugin, bulkOperationsPlugin, syncIntegrationPlugin],
  '🤝 Version Control & Collaboration': [versionHistoryPlugin, commentSystemPlugin, reviewWorkflowPlugin, conflictResolutionPlugin, teamDashboardPlugin],
...
export const PLUGIN_METADATA = {
  // Core Features
  [enhancedWordCountPlugin.id]: { category: 'Core', difficulty: 'beginner', timeToSetup: '1 min', rating: '4.9', downloadCount: '1.2k', tags: ['core', 'analytics'], featured: true },
  [newDailyNotesPlugin.id]: { category: 'Core', difficulty: 'beginner', timeToSetup: '1 min', rating: '4.8', downloadCount: '980', tags: ['core', 'daily'], featured: true },
  [tableOfContentsPlugin.id]: { category: 'Core', difficulty: 'beginner', timeToSetup: '1 min', rating: '4.7', downloadCount: '856', tags: ['core', 'navigation'], featured: true },
  [linkCheckerPlugin.id]: { category: 'Core', difficulty: 'intermediate', timeToSetup: '2 min', rating: '4.6', downloadCount: '743', tags: ['core', 'validation'], featured: true },
  
  // Organization
  [taskManagerPlugin.id]: { category: 'Organization', difficulty: 'beginner', timeToSetup: '2 min', rating: '4.8', downloadCount: '1.1k', tags: ['organization', 'tasks'], featured: true },
  [projectTrackerPlugin.id]: { category: 'Organization', difficulty: 'intermediate', timeToSetup: '3 min', rating: '4.7', downloadCount: '892', tags: ['organization', 'projects'], featured: true },
  
  // Phase 1 Data & Analytics
  [dataVisualizationPlugin.id]: { category: 'Data Analytics', difficulty: 'intermediate', timeToSetup: '5 min', rating: '4.8', downloadCount: '567', tags: ['charts', 'visualization'], featured: true },
  [dashboardBuilderPlugin.id]: { category: 'Data Analytics', difficulty: 'advanced', timeToSetup: '8 min', rating: '4.7', downloadCount: '423', tags: ['dashboard', 'analytics'], featured: false },
  [reportGeneratorPlugin.id]: { category: 'Data Analytics', difficulty: 'intermediate', timeToSetup: '5 min', rating: '4.6', downloadCount: '389', tags: ['reports', 'automation'], featured: false },
  
  // Phase 1 Automation & Integration  
  [automationRulesPlugin.id]: { category: 'Automation', difficulty: 'intermediate', timeToSetup: '6 min', rating: '4.7', downloadCount: '445', tags: ['automation', 'rules'], featured: true },
  [webhookIntegrationPlugin.id]: { category: 'Automation', difficulty: 'advanced', timeToSetup: '10 min', rating: '4.6', downloadCount: '334', tags: ['webhooks', 'integration'], featured: false },
  
  // Phase 1 Version Control & Collaboration
  [versionHistoryPlugin.id]: { category: 'Collaboration', difficulty: 'intermediate', timeToSetup: '4 min', rating: '4.8', downloadCount: '512', tags: ['version-control', 'history'], featured: true },
  [commentSystemPlugin.id]: { category: 'Collaboration', difficulty: 'beginner', timeToSetup: '3 min', rating: '4.7', downloadCount: '478', tags: ['comments', 'collaboration'], featured: true },
  
  // Phase 2 Enhanced Content Creation
  [advancedMarkdownEditorPlugin.id]: { category: 'Content Creation', difficulty: 'intermediate', timeToSetup: '5 min', rating: '4.8', downloadCount: '623', tags: ['editor', 'markdown'], featured: false },
  [templateEnginePlugin.id]: { category: 'Content Creation', difficulty: 'beginner', timeToSetup: '3 min', rating: '4.6', downloadCount: '445', tags: ['templates', 'snippets'], featured: false },
  
  // Phase 2 Search & Discovery
  [smartSearchPlugin.id]: { category: 'Search', difficulty: 'intermediate', timeToSetup: '4 min', rating: '4.8', downloadCount: '567', tags: ['search', 'AI'], featured: true },
  [tagManagerPlugin.id]: { category: 'Search', difficulty: 'beginner', timeToSetup: '2 min', rating: '4.7', downloadCount: '489', tags: ['tags', 'organization'], featured: false },
  
  // Phase 2 Knowledge Enhancement
  [knowledgeGraphPlugin.id]: { category: 'Knowledge', difficulty: 'advanced', timeToSetup: '8 min', rating: '4.9', downloadCount: '389', tags: ['graph', 'visualization'], featured: true },
  [learningPathPlugin.id]: { category: 'Knowledge', difficulty: 'intermediate', timeToSetup: '5 min', rating: '4.6', downloadCount: '334', tags: ['learning', 'paths'], featured: false }
};
