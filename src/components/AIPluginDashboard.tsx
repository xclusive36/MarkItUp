...
export default function AIPluginDashboard({ notes, isOpen, onClose }: AIPluginDashboardProps) {
              ...
              <div className="mb-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {quickActions.map(action => {
                    const isInstalled = pluginManager
                      ? pluginManager.isPluginInstalled(action.id)
                      : false;
